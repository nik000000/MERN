...
var require_index_es5_min = __commonJS({
  "node_modules/countries-list/dist/index.es5.min.js"(exports, module) {
    !function(n, a) {
      ...
      function g(n2) {
        ...
        const i2 = n2.length;
        for (; e2 < i2; ) {
          const t2 = n2.charCodeAt(e2++);
          if (t2 >= 55296 && t2 <= 56319 && e2 < i2) {
            const i3 = n2.charCodeAt(e2++);
            56320 == (64512 & i3) ? a2.push(((1023 & t2) << 10) + (1023 & i3) + 65536) : (a2.push(t2), e2--);
          } else
            a2.push(t2);
        }
        return a2;
      }
      const v = function(n2, a2) {
        return n2 + 22 + 75 * (n2 < 26) - ((0 != a2) << 5);
      }, p = function(n2, a2, e2) {
        let i2 = 0;
        for (n2 = e2 ? u(n2 / 700) : n2 >> 1, n2 += u(n2 / a2); n2 > 455; i2 += o)
          n2 = u(n2 / 35);
        return u(i2 + 36 * n2 / (n2 + 38));
      }, h = function(n2) {
        const a2 = [], e2 = n2.length;
        let i2 = 0, m2 = 128, r2 = 72, c2 = n2.lastIndexOf("-");
        c2 < 0 && (c2 = 0);
        for (let e3 = 0; e3 < c2; ++e3)
          n2.charCodeAt(e3) >= 128 && U("not-basic"), a2.push(n2.charCodeAt(e3));
        for (let F2 = c2 > 0 ? c2 + 1 : 0; F2 < e2; ) {
          let c3 = i2;
          for (let a3 = 1, m3 = o; ; m3 += o) {
            F2 >= e2 && U("invalid-input");
            const c4 = (l2 = n2.charCodeAt(F2++)) - 48 < 10 ? l2 - 22 : l2 - 65 < 26 ? l2 - 65 : l2 - 97 < 26 ? l2 - 97 : o;
            (c4 >= o || c4 > u((t - i2) / a3)) && U("overflow"), i2 += c4 * a3;
            const s3 = m3 <= r2 ? 1 : m3 >= r2 + 26 ? 26 : m3 - r2;
            if (c4 < s3)
              break;
            const g2 = o - s3;
            a3 > u(t / g2) && U("overflow"), a3 *= g2;
          }
          const s2 = a2.length + 1;
          r2 = p(i2 - c3, s2, 0 == c3), u(i2 / s2) > t - m2 && U("overflow"), m2 += u(i2 / s2), i2 %= s2, a2.splice(i2++, 0, m2);
        }
        var l2;
        return String.fromCodePoint(...a2);
      }, j = function(n2) {
        const a2 = [];
        let e2 = (n2 = g(n2)).length, i2 = 128, m2 = 0, r2 = 72;
        for (const e3 of n2)
          e3 < 128 && a2.push(F(e3));
        let c2 = a2.length, l2 = c2;
        for (c2 && a2.push("-"); l2 < e2; ) {
          let e3 = t;
          for (const a3 of n2)
            a3 >= i2 && a3 < e3 && (e3 = a3);
          const s2 = l2 + 1;
          e3 - i2 > u((t - m2) / s2) && U("overflow"), m2 += (e3 - i2) * s2, i2 = e3;
          for (const e4 of n2)
            if (e4 < i2 && ++m2 > t && U("overflow"), e4 == i2) {
              let n3 = m2;
              for (let e5 = o; ; e5 += o) {
                const i3 = e5 <= r2 ? 1 : e5 >= r2 + 26 ? 26 : e5 - r2;
                if (n3 < i3)
                  break;
                const t2 = n3 - i3, m3 = o - i3;
                a2.push(F(v(i3 + t2 % m3, 0))), n3 = u(t2 / m3);
              }
              a2.push(F(v(n3, 0))), r2 = p(m2, s2, l2 == c2), m2 = 0, ++l2;
            }
          ++m2, ++i2;
        }
        return a2.join("");
      };
      var E = { version: "2.1.0", ucs2: { decode: g, encode: (n2) => String.fromCodePoint(...n2) }, decode: h, encode: j, toASCII: function(n2) {
        return s(n2, function(n3) {
          return r.test(n3) ? "xn--" + j(n3) : n3;
        });
      }, toUnicode: function(n2) {
        return s(n2, function(n3) {
          return m.test(n3) ? h(n3.slice(4).toLowerCase()) : n3;
        });
      } };
      const { ucs2: { decode: y, encode: A } } = E, S = 127462 - "A".charCodeAt(0), d = /^[A-Z]{2}$/;
      return { continents: n, countries: a, languages: e, languagesAll: i, getEmojiFlag: (n2) => d.test(n2) ? A(n2.split("").map((n3) => S + n3.charCodeAt(0))) : "", getUnicode: (n2) => y(n2).map((n3) => "U+" + Number(n3).toString(16).toUpperCase()).join(" ") };
    });
  }
});
export default require_index_es5_min();
/*! Bundled license information:

countries-list/dist/index.es5.min.js:
